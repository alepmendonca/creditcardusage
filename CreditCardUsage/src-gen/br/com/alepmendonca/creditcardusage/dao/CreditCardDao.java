...
public class CreditCardDao extends AbstractDao<CreditCard, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FinalNumbers = new Property(1, int.class, "finalNumbers", false, "FINAL_NUMBERS");
        public final static Property Issuer = new Property(2, String.class, "issuer", false, "ISSUER");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CREDIT_CARD' (" + //
                ...
                "'FINAL_NUMBERS' INTEGER NOT NULL ," + // 1: finalNumbers
                "'ISSUER' TEXT," + // 2: issuer
                "'OWNER' TEXT);"); // 3: owner
    }
    ...
    protected void bindValues(SQLiteStatement stmt, CreditCard entity) {
        ...
        stmt.bindLong(2, entity.getFinalNumbers());
 
        String issuer = entity.getIssuer();
        if (issuer != null) {
            stmt.bindString(3, issuer);
        }
    ...
    @Override
    protected void attachEntity(CreditCard entity) {
    ...
    public CreditCard readEntity(Cursor cursor, int offset) {
        CreditCard entity = new CreditCard( //
            ...
            cursor.getInt(offset + 1), // finalNumbers
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // issuer
    ...
    public void readEntity(Cursor cursor, CreditCard entity, int offset) {
        ...
        entity.setFinalNumbers(cursor.getInt(offset + 1));
        entity.setIssuer(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
