...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        StoreTypeDao.createTable(db, ifNotExists);
        StoreDao.createTable(db, ifNotExists);
        CreditCardDao.createTable(db, ifNotExists);
        CardReceiptDao.createTable(db, ifNotExists);
        CardExtractDao.createTable(db, ifNotExists);
        CardExtractToReceiptsDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        StoreTypeDao.dropTable(db, ifExists);
        StoreDao.dropTable(db, ifExists);
        CreditCardDao.dropTable(db, ifExists);
        CardReceiptDao.dropTable(db, ifExists);
        CardExtractDao.dropTable(db, ifExists);
        CardExtractToReceiptsDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(StoreTypeDao.class);
        registerDaoClass(StoreDao.class);
        registerDaoClass(CreditCardDao.class);
        registerDaoClass(CardReceiptDao.class);
        registerDaoClass(CardExtractDao.class);
        registerDaoClass(CardExtractToReceiptsDao.class);
    }
