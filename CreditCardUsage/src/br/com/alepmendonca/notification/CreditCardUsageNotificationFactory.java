...
public class CreditCardUsageNotificationFactory {
	...
	public static void createNotifications(List<Object> messages, Context context) {
	...
	private static void createCardReceiptNotification(List<CardReceipt> receipts, Context context) {
	...
	private static void displayNotification(Notification.Builder mBuilder, int notificationId, Context context) {
	...
	private static void createCardExtractNotification(List<CardExtract> extracts, Context context) {
		
	}

	private CreditCardUsageNotificationFactory() {}
}
