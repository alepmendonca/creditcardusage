...
public class GmailContract {
     ...
     */
    public boolean canReadLabels(Context c) {
        ...
        try {
        	...
        	Log.e(BradescoMailProperties.TAG, "GMail app not found", e);
        }
        return supported;
    }
    ...
    public static final class Labels {
        ...
        public static Uri getLabelUri(String account, int labelId) {
